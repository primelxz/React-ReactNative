...
function calculateSubtotal() {
	...
	let totalPrice = bagelQuantity * 1.5 + donutQuantity + muffinQuantity * 2 + pieQuantity * 4.5 + cakeQuantity * 7;
	return totalPrice;
}

function calculateSalesTax() {
	const stateChosen = document.getElementById("stateTax").value;
	let stateTax = SALES_TAX[stateChosen];
	let price = calculateSubtotal();
	let salesTax = roundMoney(stateTax * price);
	return salesTax;
}
